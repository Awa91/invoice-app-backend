    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('marketing', 'Marketing'), ('software', 'Software'), ('travel', 'Travel'), ('equipment', 'Equipment'), ('office', 'Office'), ('other', 'Other')], default='other', max_length=20)),
